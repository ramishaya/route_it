...
import 'package:route_it/core/utils/constants/text_strings.dart';
...
import 'package:route_it/features/roadmaps/presentation/views/roadmaps_details_view/widgets/info_container.dart';
import 'package:route_it/features/roadmaps/presentation/views/roadmaps_details_view/widgets/roadmap_details_shimmer.dart';
import 'package:route_it/features/roadmaps/presentation/views/roadmaps_details_view/widgets/skill_tile.dart';
    ...
    return BlocBuilder<RoadMapSkillsCubit, RoadMapSkillsState>(
      builder: (context, state) {
        if (state is RoadMapSkillsLoaded) {
                ...
                children: skills.map((skill) {
                  return GestureDetector(
                    onTap: () => GoRouter.of(context)
                        .push(AppRouter.kSkillView, extra: skill),
                    child: SkillTile(
                      title: skill.title!,
          ...
          return const RoadMapDetailsShimmer();
        }
      },
    );
  }
