...
import 'package:route_it/features/roadmaps/presentation/views/roadmaps_view/widgets/roadmap_card.dart';
import 'package:route_it/features/roadmaps/presentation/views/roadmaps_view/widgets/shimmer_animation_builder.dart';
      ...
      body: BlocBuilder<RoadMapsCubit, RoadMapsState>(
        builder: (context, state) {
          if (state is RoadMapsLoaded) {
            ...
            return const ShimmerAnimationBuilder();
          }
        },
      ),
    );
