...
import 'package:route_it/features/competition/presentation/views/competitions_view/competitions_view.dart';
...
import 'package:route_it/features/search/presentation/views/general_search_view/general_search_view.dart';
...
class HomeView extends StatelessWidget {
  ...
  final List<Widget> navPages = const [
    ...
    CompetitionsView(),
    GeneralSearchView(),
    Center(child: Text("Profile")), // Updated the last tab
  ];
